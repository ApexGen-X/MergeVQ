...
python evaluation.py --config_file configs/npu/imagenet_lfqgan_128_L.yaml --ckpt_path /liuzicheng/zly/.cache/Open_MAGVIT2/imagenet_128_L.ckpt --image_size 128
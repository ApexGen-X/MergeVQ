...
### GPU x 8 train
python main.py fit --config configs/gpu_s1/imagenet_mergevq_256_G_d64_8gpu_100ep.yaml
...
CONFIG_TAIL=".yaml"
RESULT_BASE="results/stage1_pt/imagenet_mergevq_256_G_d64_8gpu_100ep/test/eval_k"
RESULT_TAIL=".txt"
# list of KEEP values and GPU IDs
KEEP_VALUES=("256" "400" "576" "1024")
IMAGE_SIZE="256"
# modify the path of checkpoint and available GPU IDs
CKPT="checkpoints/stage1_pt/imagenet_mergevq_256_G_d64_8gpu_100ep/epoch=99-step=1000900.ckpt"
GPUS=("0" "1" "2" "3")
